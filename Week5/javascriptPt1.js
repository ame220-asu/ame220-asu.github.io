...
console.log(
  `This is a string that has been interpolated with a number value ${numberVar}`,
);
...
console.log(
  `So, for example if I wwanted to call "hello", it would be someARray[1] ${someArray[1]}`,
);
